#ifndef TALIB_ITEMPROP_ADDITIONAL_H
#define TALIB_ITEMPROP_ADDITIONAL_H

struct ItemPropertyAdditional {
    ...
    static std::string toString(CNWItemProperty* ip,
                                int32_t version) {
        C2DA *dmg = nwn_GetCached2da("iprp_addcost");
...
#endif // TALIB_ITEMPROP_ADDITIONAL_H

...
struct CNWSCombatRound_s {
    ...
    uint8_t                       field_83;
    uint8_t                       field_84;
    int32_t                       cr_parry_index;                /* 0x2124 */
    int32_t                       cr_num_AOOs;                   /* 0x2128 */
    int32_t                       cr_num_cleaves;                /* 0x212C */
    int32_t                       cr_num_circle_kicks;           /* 0x2130 */
    uint32_t                      cr_new_target;
    int32_t                       cr_onhand_atks;                /* 0x2138 */
    int32_t                       cr_offhand_atks;               /* 0x213C */
    int32_t                       cr_offhand_taken;              /* 0x2140 */
    int32_t                       cr_extra_taken;                /* 0x2144 */
    int32_t                       cr_additional_atks;            /* 0x2148 */
    int32_t                       cr_effect_atks;                /* 0x214C */
